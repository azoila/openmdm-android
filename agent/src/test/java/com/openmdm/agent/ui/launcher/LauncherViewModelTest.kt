...
class LauncherViewModelTest {
    ...
    @Test
    fun `enrollment screen shows auto-enrolling while provisioning work is pending`() = runTest(testDispatcher) {
        enrollmentStateFlow.value = EnrollmentState(isEnrolled = false)
        every { workScheduler.isProvisioningEnrollmentPending() } returns true
